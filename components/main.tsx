...
import { Webiner } from '@/app/webiner';
const main = () => {
  return (
    <div className='flex justify-center items-center flex-col' >
      ...
      {/* Main Front Part */}
        ...
        <div className='flex flex-col items-center'>
          <p className='text-gray-400 font-bold'>LATEST ARTICLE</p>
          <h1 className='text-[2.5rem] text-black dark:text-white font-bold'>See Webinar of e16 Classes</h1>
          <Webiner/>
        </div>
